...
class MyService:Service(){
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val myPhoneNumber=userData.loadNumber()
        databaseRef!!.child("Users").child(myPhoneNumber.toString()).child("request").addValueEventListener(
            object : ValueEventListener {
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    val date = Date()
                    databaseRef!!.child("Users").child(myPhoneNumber.toString())
                    ...
                    databaseRef!!.child("Users").child(myPhoneNumber.toString())
                        .child("location").child("Last Seen").setValue( df.format(date).toString())
                }
